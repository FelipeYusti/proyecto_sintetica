<div id="loading" style="border-color: azure;">
      ...
      <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
        ...
        <li class="nav-item">
          ...
          <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
            <li class="nav-item">
              <a class="nav-link <?= $data['page_name'] != 'users' ? 'collapsed' : '' ?>"
                href="<?= base_url() ?>/users">
            ...
            <li class="nav-item">
              <a class="nav-link <?= $data['page_name'] != 'convenios' ? 'collapsed' : '' ?>"
                href="<?= base_url() ?>/convenios">
                <i class="icon">
                  <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M11.9488 14.54C8.49884 14.54 5.58789 15.1038 5.58789 17.2795C5.58789 19.4562 8.51765 20.0001 11.9488 20.0001C15.3988 20.0001 18.3098 19.4364 18.3098 17.2606C18.3098 15.084 15.38 14.54 11.9488 14.54Z"
            ...
            <li class="nav-item">
              <a class="nav-link <?= $data['page_name'] != 'showCanchas' ? 'collapsed' : '' ?>"
                href="<?= base_url() ?>/showCanchas">
                <i class="icon">
        ...
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-auth" role="button" aria-expanded="false"
            ...
            <span class="item-name">Canchas</span>
            <i class="right-icon">
              <svg class="icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
          ...
          <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
            <li class="nav-item">
              <a class="nav-link <?= $data['page_name'] != 'reservas' ? 'collapsed' : '' ?>"
                href="<?= base_url() ?>/reservas">
                <i class="icon">
                  <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                    fill="currentColor">
                    <g>
            ...
            <li class="nav-item">
              <a class="nav-link <?= $data['page_name'] != 'canchas' ? 'collapsed' : '' ?>"
                href="<?= base_url() ?>/canchas">
                <i class="icon">
                  <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                    fill="currentColor">
                    <g>
        ...
        <li class="nav-item">
          <a class="nav-link" href="../dashboard/admin.html">
            ...
            <span class="item-name">Salir</span>
          </a>
        </li>
        <li>
          <hr class="hr-horizontal" />
