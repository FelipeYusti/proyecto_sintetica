            ...
            <ul class="p-0 m-0 mb-2 swiper-wrapper list-inline">
              <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <div>
                      <span><b>Ganancias</b></span>
                      <div class="mt-2">
                        <h2 class="counter" id="totalAno"></h2>
                      </div>
                    </div>
                    <div>
                      <span class="badge bg-success">Año</span>
                    </div>
                  </div>
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <div>
                      <span><b>Ganancias</b></span>
                      <div class="mt-2">
                        <h2 class="counter" id="totalMes"></h2>
                      </div>
                    </div>
                    <div>
              ...
              <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="900">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between">
                      <div>
                        <span><b>Reservas</b></span>
                        <div class="mt-2">
                          <h2 class="counter" id="reservasAno"></h2>
                        </div>
                      </div>
                      <div>
                        <span class="badge bg-warning">Año</span>
                      </div>
                    </div>
                    <div class="d-flex justify-content-between mt-2">
                      <div>
                        <span>Reservas Anual</span>
                      </div>
                      <div>
                    ...
                    <div class="mt-3">
                      <div class="progress bg-soft-warning shadow-none w-100" style="height: 6px">
                        <div class="progress-bar bg-warning" data-toggle="progress-bar" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <div>
                      <span><b>Reservas</b></span>
                      <div class="mt-2">
                        <h2 class="counter" id="reservasMes"></h2>
                      </div>
                    </div>
                    <div>
                      <span class="badge bg-info">Mes</span>
                    </div>
                  </div>
                  <div class="d-flex justify-content-between mt-2">
                    <div>
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <div>
                      <span><b>Reservas</b></span>
                      <div class="mt-2">
                        <h2 class="counter" id="reservasHoy"></h2>
                      </div>
                    </div>
                    <div>
                  ...
                  <div class="mt-3">
                    <div class="progress bg-soft-danger shadow-none w-100" style="height: 6px">
                      <div class="progress-bar bg-danger" data-toggle="progress-bar" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </div>
              </li>
              <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="1000">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <div>
                      <span><b>Convenios</b></span>
                      <div class="mt-2">
                        <h2 class="counter" id="convenios"></h2>
                      </div>
                    </div>
                    <div>
                      <span class="badge bg-primary">Exitentes</span>
                    </div>
                  </div>
                  <div class="d-flex justify-content-between mt-2">
                    <div>
                      <span>Total exitentes</span>
                    </div>
                    <div>
                      <span>35%</span>
                    </div>
